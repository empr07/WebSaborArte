...
if (id_usuario > 0) {
    fetch("https://api-saboryarte.onrender.com/api/auth/usuarios/" + id_usuario, {
        headers: {
...
function save() {
    ...
    fetch(localStorage.getItem("id_usuario") ? "https://api-saboryarte.onrender.com/api/auth/usuarios/updateadmin?idusuario=" + localStorage.getItem("id_usuario") : "https://api-saboryarte.onrender.com/api/auth/registroadmin", {
