...
let url = 'https://api-saboryarte.onrender.com/api/auth/usuarios'
...
fetch(url, {
    ...
    .then(data => {
        data.forEach(usuario => {
            ...
            let esadministrador = usuario.esadministrador ? "Administrador" : "Usuario"
...
function editar(id_usuario) {
    ...
    window.location.href = './FormularioUsuarios.html'
}
